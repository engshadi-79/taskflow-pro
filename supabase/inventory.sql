...
tools_seed(track_name, position, tool_name, unit, total_quantity, group_label) as (
  values
    -- مسار الحلاقة الرجالية
    ('مسار الحلاقة الرجالية', 1, 'ماكنة موزر (النمر 1 +3)', null, '1', null),
    ('مسار الحلاقة الرجالية', 2, 'طقم نمر 4 ((1+2+3+4)النمر)', null, '1', null),
    ('مسار الحلاقة الرجالية', 3, 'ماكنة Kemi ((1+2+3+4)النمر)', null, '1', null),
    ('مسار الحلاقة الرجالية', 4, 'ماكنة جيمي (شاحن)', null, '1', null),
    ('مسار الحلاقة الرجالية', 5, 'ماكنة Vgr (كرتونة)', null, 'مفقودة', null),
    ('مسار الحلاقة الرجالية', 6, 'فرشاة تك', null, '2', null),
    ('مسار الحلاقة الرجالية', 7, 'فرشاة ناعمة', null, '2', null),
    ('مسار الحلاقة الرجالية', 8, 'مقص', null, '5', null),
    ('مسار الحلاقة الرجالية', 9, 'مشط تدريج', null, '4', null),
    ('مسار الحلاقة الرجالية', 10, 'مشط تدريج شعر', null, '2', null),
    ('مسار الحلاقة الرجالية', 11, 'ملاقط', null, '16', null),
    ('مسار الحلاقة الرجالية', 12, 'فراشي ذقن', null, '5', null),
    ('مسار الحلاقة الرجالية', 13, 'مشط كبير', null, '2', null),
    ('مسار الحلاقة الرجالية', 14, 'صبانة بلاستيك', null, '3', null),
    ('مسار الحلاقة الرجالية', 15, 'بخاخ مياه', null, '2', null),
    ('مسار الحلاقة الرجالية', 16, 'مشط مكوبح', null, '8', null),
    ('مسار الحلاقة الرجالية', 17, 'دفتر تشكيلة أمشاط', null, '8', null),
    ('مسار الحلاقة الرجالية', 18, 'موس حلاقة', null, '25', null),
    ('مسار الحلاقة الرجالية', 19, 'مريول', null, '8', null),
    ('مسار الحلاقة الرجالية', 20, 'مناشف', null, '5', null),
    ('مسار الحلاقة الرجالية', 21, 'معجون حلاقة', null, '12', null),

    -- مسار التجميل النسائي - كوافير
    ('مسار التجميل النسائي - كوافير', 1, 'جهاز استشورا', null, '1', null),
    ('مسار التجميل النسائي - كوافير', 2, 'جهاز فير', null, '1', null),
    ('مسار التجميل النسائي - كوافير', 3, 'جهاز واكس شمع', null, '1', null),
    ('مسار التجميل النسائي - كوافير', 4, 'امشاط شعر فرش', null, '2', null),
    ('مسار التجميل النسائي - كوافير', 5, 'امشاط سشوار', null, '5', null),
    ('مسار التجميل النسائي - كوافير', 6, 'امشاط', null, '22', null),
    ('مسار التجميل النسائي - كوافير', 7, 'فرش صبغة', null, '8', null),
    ('مسار التجميل النسائي - كوافير', 8, 'طقية ميش', null, '1', null),
    ('مسار التجميل النسائي - كوافير', 9, 'طاقية نايلون مؤقتة', null, '12', null),
    ('مسار التجميل النسائي - كوافير', 10, 'قلفز', null, '12', null),
    ('مسار التجميل النسائي - كوافير', 11, 'كاب', null, '2', null),
    ('مسار التجميل النسائي - كوافير', 12, 'صحون صبغة', null, '6', null),
    ('مسار التجميل النسائي - كوافير', 13, 'شبك تساريح', null, '12', null),
    ('مسار التجميل النسائي - كوافير', 14, 'صوف تساريح', null, '12', null),
    ('مسار التجميل النسائي - كوافير', 15, 'صبغات', null, '12', null),
    ('مسار التجميل النسائي - كوافير', 16, 'فرد شعر', null, '2', null),
    ('مسار التجميل النسائي - كوافير', 17, 'بروتين', null, 'لتر', null),
    ('مسار التجميل النسائي - كوافير', 18, 'شامبو', null, '4 لتر', null),
    ('مسار التجميل النسائي - كوافير', 19, 'حمام زيت', null, '3', null),
    ('مسار التجميل النسائي - كوافير', 20, 'كريم شعر', null, '1', null),
    ('مسار التجميل النسائي - كوافير', 21, 'مثبت شعر', null, '3', null),

    -- مسار التطريز والخياطة (مجمّعة حسب الماكينة)
    ('مسار التطريز والخياطة', 1, 'فلتر', null, '1', 'ماكنة الحبكة'),
    ('مسار التطريز والخياطة', 2, 'مفك ابر', null, '1', 'ماكنة الحبكة'),
    ('مسار التطريز والخياطة', 3, 'ملقط', null, '1', 'ماكنة الحبكة'),
    ('مسار التطريز والخياطة', 4, 'مفك وسط', null, '1', 'ماكنة الحبكة'),
    ('مسار التطريز والخياطة', 5, 'مفتاح ايلين', null, '6', 'ماكنة الحبكة'),
    ('مسار التطريز والخياطة', 6, 'مفتاح شق', null, '3', 'ماكنة الحبكة'),
    ('مسار التطريز والخياطة', 7, 'ابر ماكنة حبكة', null, 'دستة', 'ماكنة الحبكة'),
    ('مسار التطريز والخياطة', 8, 'شفرة حبكة', null, '1', 'ماكنة الحبكة'),
    ('مسار التطريز والخياطة', 9, 'مفتاح شق', null, '2', 'ماكنة الدرزة'),
    ('مسار التطريز والخياطة', 10, 'مفك صغير', null, '1', 'ماكنة الدرزة'),
    ('مسار التطريز والخياطة', 11, 'مفك وسط', null, '1', 'ماكنة الدرزة'),
    ('مسار التطريز والخياطة', 12, 'مكوك', null, '2', 'ماكنة الدرزة'),
    ('مسار التطريز والخياطة', 13, 'ابر دستة', null, '1', 'ماكنة الدرزة'),
    ('مسار التطريز والخياطة', 14, 'مزيتة', null, '1', 'ماكنة الدرزة'),
    ('مسار التطريز والخياطة', 15, 'مفتاح ايلين', null, '6', 'ماكنة الابارات'),
    ('مسار التطريز والخياطة', 16, 'مفك صغير', null, '1', 'ماكنة الابارات'),
    ('مسار التطريز والخياطة', 17, 'مفك وسط', null, '1', 'ماكنة الابارات'),
    ('مسار التطريز والخياطة', 18, 'ابر', null, '1', 'ماكنة الابارات'),
    ('مسار التطريز والخياطة', 19, 'فلتر لماكنة الابارات', null, '1', 'ماكنة الابارات'),
    ('مسار التطريز والخياطة', 20, 'طقم براغي', null, '1', 'ماكنة الابارات'),
    ('مسار التطريز والخياطة', 21, 'اشتكر 3 عيون', null, '5', null),

    -- مسار صناعة الاكسسوارات والأشغال اليدوية
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 1, 'ورق A4 ملون', 'دستة', '1', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 2, 'ورق فوم لامع A4', 'دستة', '2', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 3, 'اعواد شوي خشبية', 'دستة', '10', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 4, 'أحبال خيش', 'لفة', '10', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 5, 'فوم بورد ابيض', 'لوح', '8', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 6, 'ورق بسكوت اصفر', 'لوح', '5', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 7, 'عرق الكرز', 'عرق', '4', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 8, 'شبر سيتان', 'لفة', '19', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 9, 'خيش عريض مع دانتيل', 'لفة', '5', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 10, 'ورق شجر بلاستيك', 'عرق', '4', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 11, 'ورق تغليف نايلون', 'دستة', '8', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 12, 'ورق تغليف خفيف', 'دستة', '6', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 13, 'ورق كريشه', 'لفة', '2', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 14, 'شبر سحاب', 'دستة', '3', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 15, 'خيط مطاطي', 'لفة', '20', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 16, 'حبل اكسسوارات بلاستيك غير مطاطي', 'لفة', '1', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 17, 'قماش كتان', 'متر', '5', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 18, 'سلسلة اكسسوار اسود', 'لفة', '1', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 19, 'سلسلة اكسسوار فضي', 'لفة', 'نصف لفة', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 20, 'لاصق دبل فيس ابيض', 'لفة', '8', null),
    ('مسار صناعة الاكسسوارات والأشغال اليدوية', 21, 'لاصق دبل فيس شفاف', 'لفة', '20', null),

    -- مسار الترجمة والعمل الحر الرقمي
    ('مسار الترجمة والعمل الحر الرقمي', 1, 'شاشة Konja 50 بوصة', null, '1', null),
    ('مسار الترجمة والعمل الحر الرقمي', 2, 'ريموت شاشة', null, '1', null),
    ('مسار الترجمة والعمل الحر الرقمي', 3, 'ستاند ابيض', null, '1', null),
    ('مسار الترجمة والعمل الحر الرقمي', 4, 'اشتيكر 3 عيون', null, '6', null),
    ('مسار الترجمة والعمل الحر الرقمي', 5, 'مساحة', null, '1', null),
    ('مسار الترجمة والعمل الحر الرقمي', 6, 'طاولات خشبية', null, '9', null),
    ('مسار الترجمة والعمل الحر الرقمي', 7, 'كرسي خشب', null, '1', null),
    ('مسار الترجمة والعمل الحر الرقمي', 8, 'كرسي بلاستيك بدون ايد', null, '27', null),
    ('مسار الترجمة والعمل الحر الرقمي', 9, 'وحدة انترنت', null, '1', null)
)
insert into public.inventory_tools (track_id, organization_id, name, unit, total_quantity, group_label, position)
select at.id, t.org_id, ts.tool_name, ts.unit, ts.total_quantity, ts.group_label, ts.position
from tools_seed ts
join all_tracks at on at.name = ts.track_name
cross join target t
where not exists (
  -- name alone isn't unique within a track (the embroidery track has the
  -- same tool name, e.g. "مفتاح شق", under more than one machine group),
  -- so re-run idempotency has to match on the group too
  select 1 from public.inventory_tools tool2
  where tool2.track_id = at.id
    and tool2.name = ts.tool_name
    and tool2.group_label is not distinct from ts.group_label
);
