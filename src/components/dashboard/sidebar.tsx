...
const NAV_BY_ROLE: Record<Role, NavSection[]> = {
  super_admin: [
    ...
    {
      label: "الطلبات وسير العمل",
      items: [WORKFLOW_REQUESTS, APPROVALS, WORKFLOW_TEMPLATES, AUTOMATION_RULES, WORKFLOW_BUILDER],
    },
    { label: "التقارير والأداء", items: [REPORTS, DECISIONS, PERFORMANCE, SLA_REPORT, SLA_POLICIES] },
  ...
  department_manager: [
    ...
    { label: "التقارير والأداء", items: [REPORTS, DECISIONS, PERFORMANCE, SLA_REPORT] },
